 ...
 * @LastEditTime: 2020-09-10 14:47:25
...
const path = {
    ...
    // 商品分类
    goods_sort: '/pages/goods_sort/index',
    // 详情
    goods_detail: '/pages/goods_detail/index',
    // 购物车
    ...
    // 地址
    address_list: '/pages/address/index',
    // 新增地址
